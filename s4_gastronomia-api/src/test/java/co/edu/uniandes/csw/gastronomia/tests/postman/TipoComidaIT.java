...
import co.edu.uniandes.csw.gastronomia.resources.TipoComidaResource;
...
public class TipoComidaIT {
    private static final String COLLECTION = "TipoComidasResourceTest.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s4_gastronomia-api.war")//War del modulo api
                ...
                .addPackage(TipoComidaResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(TipoComidaDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.

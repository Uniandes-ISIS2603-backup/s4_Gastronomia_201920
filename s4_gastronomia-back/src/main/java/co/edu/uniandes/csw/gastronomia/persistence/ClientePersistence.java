...
public class ClientePersistence {
    ...
    public ClienteEntity findByUsername(String username) {
        LOGGER.log(Level.INFO, "Consultando clientes por username: {0}", username);
        ...
        LOGGER.log(Level.INFO, "Saliendo de consultar clientes por username: {0}", username);
        return result;
    }
    ...
    public ClienteEntity findByEmail(String email) {
        LOGGER.log(Level.INFO, "Consultando clientes por email: {0}", email);
        ...
        LOGGER.log(Level.INFO, "Saliendo de consultar clientes por email: {0}", email);
        return result;
    }
